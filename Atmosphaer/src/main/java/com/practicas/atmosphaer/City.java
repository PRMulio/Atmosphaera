...
public class City {
    ...
    public JSONObject getCityListJSON() throws IOException {
        String content = new String(Files.readAllBytes(Paths.get("C:\\Users\\Pablo Rodríguez\\OneDrive\\Documentos\\NetBeansProjects\\ZephyrosFX\\src\\main\\resources\\com\\practicas\\zephyrosfx\\json\\cityList.json")));
