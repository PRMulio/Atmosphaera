...
import static com.practicas.atmosphaer.Utilities.calculateRomanDate;
import static com.practicas.atmosphaer.Utilities.capitalizeString;
...
public class Connection {
    ...
    public void retrieveData(City city) {
        ...
        try {
            ...
            city.setDescriptionImage("com/practicas/zephyrosfx/images/sun.png");
            city.setTemp(temp + " C");
